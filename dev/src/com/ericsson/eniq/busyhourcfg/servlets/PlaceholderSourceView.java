 ...
 *
 */
public class PlaceholderSourceView extends CommonServlet {

  /**
   * 
   */
  private static final long serialVersionUID = -8542355228941063939L;
  
  private final Logger log = Logger.getLogger(PlaceholderSourceView.class.getName());

  /**
   * @see HttpServlet#HttpServlet()
   */
  public PlaceholderSourceView() {
