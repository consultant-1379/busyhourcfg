 ...
 * 
 */
public class PlaceholderSourceBrowseViewTest {
  ...
  public void setUp() throws RemoteException {
    webmockRequest = new MockHttpServletRequest("GET", "/servlet/PlaceholderSourceBrowseView");
  ...
  public void testServiceHttpServletRequestHttpServletResponse() {
    final PlaceholderSourceBrowseView pv = new PlaceholderSourceBrowseView();
    try {
      pv.service(webmockRequest, webmockResponse);
      final String forwardURL = webmockResponse.getForwardedUrl();
      assertTrue(View.PLACEHOLDERSOURCEBROWSE_VIEW_JSP.equals(forwardURL));
    } catch (Exception e) {
      fail(e.getMessage());
    }
  }
